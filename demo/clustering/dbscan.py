...
if __name__ == "__main__":
    parser = argparse.ArgumentParser('DBSCAN',
    ...
    save_dir = f"{root_path}/demo/clustering/plots/dbscan"
    ...
    print(f"Running DBSCAN on: {included_scenarios}")
    ...
    for key in included_scenarios:
        ...
        dbs = DBSCAN(eps=scenario.eps, min_samples=2).fit(x, original_labels)
        labels = dbs.labels_
