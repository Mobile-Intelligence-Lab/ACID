...
if __name__ == "__main__":
    parser = argparse.ArgumentParser('Spectral Clustering',
    ...
    save_dir = f"{root_path}/demo/clustering/plots/spectral"
    ...
    print(f"Running Spectral Clustering on: {included_scenarios}")
    ...
    for key in included_scenarios:
        ...
        spectral = SpectralClustering(n_clusters=scenario.n_classes, eigen_solver='arpack',
                                      affinity="nearest_neighbors").fit(x, original_labels)
